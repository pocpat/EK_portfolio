                  ...
                  <Tab.Container id="projects-tabs" activeKey={activeTab}>
                    ...
                    >
                      ...
                      <a href="#_" class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
                        ...
                        <span class="absolute flex items-center justify-center w-full h-full text-purple-500 transition-all duration-300 transform group-hover:translate-x-full ease">Button 18</span>
                      ...
                      {activeTab === 'third' && (
                          <div>
                              <Nav variant="pills" className="nav-pills mb-3 justify-center align-items-center">
                                  {pdfFiles.map((pdf, index) => (
                                      <Nav.Item key={index}>
                                          <Nav.Link onClick={() => setSelectedPdf(pdf.file)}>{pdf.name}</Nav.Link>
                                      </Nav.Item>
                                  ))}
                              </Nav>
